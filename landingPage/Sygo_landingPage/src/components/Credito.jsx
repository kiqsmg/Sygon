...
const Credito = () => (
  <section id="carbono" className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row  flex-col rounded-[20px] box-shadow`}>
    ...
    <div className="flex-1 flex flex-col mb-10">
      <h2 className={styles.heading2}>Crédito de carbono no Brasil</h2>

      <ul className="list-inside list-disc mt-5 ml-5 font-poppins font-normal text-dimWhite text-[18px] leading-[24px]">
