const ProjectCard = ({ name, title, img, link }) => (
  ...
  <div className="flex flex-col ml-4 items-center">
    ...
    <a href={link} className="inline-flex justify-center items-center py-2 text-sm w-[8rem] font-medium text-black bg-black-gradient-2 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Know more</a>
  </div>
</div>
